...
var endExpTime, startExpTime, RT, key, fixTime, thisTrialObj, thisTrialScene, thisTrialSceneCat, practice_scenes, practice_objDict, thisObjCat,thisTrialSemCong, thisTrialObjSizeName, thisTrialRating, thisTrialSide, thisFile, objSceneSemCong, thisRatingRT, removeRatingScene, presentationSize, startRatingTrialTime, endRatingTrialTime, thisPracPresentationSize;

var trialSequence = ["p0_large_cake_L.png","p1_small_apple_L.png","p2_large_dog_R.png","p3_small_shoe_R.png","p4_large_sunglasses_R.png","p5_small_hat_L.png"];
...
var sideConds = ["L","L","L","L","L","L","L","L","L","L","L","L","R","R","R","R","R","R","R","R","R","R","R","R"]
...
function prepareForFirstPracticeTrial(){
	...
	practiceScenes = ["p0_large_cake_L","p1_small_apple_L","p2_large_dog_R","p3_small_shoe_R","p4_large_sunglasses_R","p5_small_hat_L"];
...
function prepareForPracticeTrial(){
	...
	[thisPracScene, thisPracPresentationSize, thisPracObj, thisTrialSide] = thisPracTrial.split("_");
...
function prepareForTrial(){
	...
	[thisTrialScene, thisTrialObj, thisTrialSide, thisTrialObjCat, thisTrialScale, thisTrialSceneCat, objSceneSemCong, presentationSize] = getConds();
	thisFile = chooseSetObjectScene([thisTrialScene, presentationSize, thisTrialObj, thisTrialSide]);
...
function getConds(){
	...
	return [thisTrialScene, thisTrialObj, thisTrialSide, thisTrialObjCat, thisTrialScale, thisTrialSceneCat, objSceneSemCong, presentationSize];
}

function chooseSetObjectScene([thisTrialScene, presentationSize, thisTrialObj, thisObjSide]){

	// get string name of png file
	thisFile = thisTrialScene + "_" + presentationSize + "_" + thisTrialObj + "_" + thisObjSide + ".png";
...
// 	// document.getElementById("ratingVal").value = 0; //reset value in case they don't choose one
// 	thisRatingRT = 2 * calculateAverageOfArray(thisData["RT"]);
// 	$("#ratingExperimentBox").show();
// 	$(".fixationDiv").hide();
// 	thisRatingTrialFile = getRatingTrial(); //get image scene
// 	showObjScene();
// 	$("#likert").show();
// 	console.log("rating file: " + thisRatingTrialFile);

// 	removeRatingScene = setTimeout(function(){ //hide all stimuli and gabors after fixation time + object time + gabor timeout (2s)
...
// 		// }
// 	}, thisRatingRT)
// 	// var ratingTrialOver = setTimeout(function(){ //hide all stimuli and gabors after fixation time + object time + gabor timeout (2s)
// 	// 	validateRating();
// 	// 	nextRatingTrial();
// 	// }, thisRatingRT + ratingScaleTime)
...
function nextTrial(){ //requires input variable because it is not a global variable --> different for practice and experiment blocks
	...
	if (keyDict[key] == thisTrialSide){
		prevAcc = 1;
		numCorr++;
	}
	else if (keyDict[key] != thisTrialSide){
		prevAcc = 0;
	}
...
function saveTrialData(){
	...
	thisData["experimentName"].push("OSSe5");
